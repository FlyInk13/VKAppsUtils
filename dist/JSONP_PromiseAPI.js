...
var JSONP_PromiseAPI = /*#__PURE__*/function () {
  function JSONP_PromiseAPI(_data) {
    var _this = this;
  ...
  _createClass(JSONP_PromiseAPI, [{
    ...
    value: function showCaptcha(method, params, error) {
      ...
      return new Promise(function (resolve) {
        ...
        view.setState({
          popout: /*#__PURE__*/_react["default"].createElement(_vkui.Alert, {
            ...
            alt: captcha_img
          }), /*#__PURE__*/_react["default"].createElement(_vkui.Input, {
            defaultValue: "",
        ...
        return _this3.callMethod(method, _objectSpread(_objectSpread({}, params), {}, {
